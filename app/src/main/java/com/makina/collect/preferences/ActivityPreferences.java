...
package com.makina.collect.preferences;
...
import com.makina.collect.utilities.UrlUtils;
...
public class ActivityPreferences extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mLuminosityPreference = findPreference(KEY_LUMINOSITY);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.preferences,
                                  menu);
