...
/**
 * Base client implementation to use {@link RequestHandlerService}
 * service.
 *
...
public class RequestHandlerServiceClient {
    ...
    /**
     * Messenger for communicating with {@link RequestHandlerService}.
     */
     ...
     * instance to {@link RequestHandlerService}.
     */
    public void connect() {
        connect(null);
    }
    ...
    /**
     * Connects this {@link RequestHandlerServiceClient}
     * instance to {@link RequestHandlerService} using an existing token.
     *
    ...
    /**
     * Closes the connection to {@link RequestHandlerService}.
     */
     ...
     * instance is currently connected to {@link RequestHandlerService}.
     *
    ...
    /**
     * Send a message data to {@link RequestHandlerService}.
     *
     * @param requestHandlerClass the {@link AbstractRequestHandler} to invoke
     * @param data the message to send to the server through {@link RequestHandlerService}
     */
    public void send(
    ...
    /**
     * Establishes a connection with {@link RequestHandlerService}
     * service.
     */
    ...
    /**
     * Handler of incoming messages from {@link RequestHandlerService}.
     *
     * @author <a href="mailto:sebastien.grimault@makina-corpus.com">S. Grimault</a>
     */
     ...
     * messages from {@link RequestHandlerService} service.
     *
     * @author <a href="mailto:sebastien.grimault@makina-corpus.com">S. Grimault</a>
     */
    public interface ServiceClientListener {
        ...
        /**
         * After calling {@link RequestHandlerServiceClient#connect()},
         * this method will be invoked asynchronously when the connect request has successfully completed.
         *
         * @param token the token to use to send {@code Message} through {@link RequestHandlerServiceClient#send(Class, Bundle)}
         */
        void onConnected(@NonNull final String token);

        /**
         * Called when the client is disconnected from {@link RequestHandlerService}.
         */
        void onDisconnected();
