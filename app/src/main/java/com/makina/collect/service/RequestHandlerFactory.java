...
/**
 * {@code Factory} used to create {@link AbstractRequestHandler} instance
...
public class RequestHandlerFactory {
    ...
    /**
     * Returns a single instance of {@link RequestHandlerFactory}.
     *
    ...
    /**
     * Tries to find the right implementation of {@link AbstractRequestHandler}
     * from a given {@code Message} received from {@link RequestHandlerService}.
     *
     * @param context the current context
     * @param message the {@code Message} to parse
     *
     * @return the right implementation of {@link AbstractRequestHandler}
    ...
    /**
     * Tries to find from the given {@code List} the right implementation of {@link AbstractRequestHandler}
     * from a given {@code Message} received from {@link RequestHandlerService}.
     *
     * @param message         the {@code Message} to parse
     * @param requestHandlers a {@code List} of {@link AbstractRequestHandler} on which to iterate
     *
     * @return the right implementation of {@link AbstractRequestHandler}
     * according to the given {@code Message} or {@code null} if not found
     */
