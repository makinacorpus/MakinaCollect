 ...
 *
 */
public class SendFormsListAdapter extends BaseAdapter {
	
	private Activity activity;
    private static LayoutInflater inflater=null;
    private List<Form> forms;

    public SendFormsListAdapter(Activity activity, List<Form> forms)
    {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		 View vi=convertView;
         if(convertView==null)
            vi = inflater.inflate(R.layout.listview_item_send_form, null);
