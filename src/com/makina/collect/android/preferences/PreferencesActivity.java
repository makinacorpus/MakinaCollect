...
public class PreferencesActivity extends SherlockPreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String themeChoice = PreferenceManager.getDefaultSharedPreferences(this).getString(PreferencesActivity.KEY_THEME, PreferencesActivity.KEY_THEME);
		...
		mLuminosityPreference.setOnPreferenceClickListener(new OnPreferenceClickListener()
		{
			...
			public boolean onPreferenceClick(Preference arg0)
			{
				 LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
				    ...
				    AlertDialog.Builder builder = new AlertDialog.Builder(PreferencesActivity.this).setView(layout);
		...
		mThemePreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener()
		{
			...
			public boolean onPreferenceChange(Preference preference,Object newValue)
			{
				...
				if (index==0)
				{
					Theme.changeToTheme(PreferencesActivity.this, Theme.THEME_DARK);
				}
				else
					Theme.changeToTheme(PreferencesActivity.this, Theme.THEME_LIGHT);
				return true;
			}
		});
