...
public class ActivityForm2 extends SherlockActivity implements
						...
						public void onClick(View v) {
							...
							if (checkBox1.isChecked()) {
								if (saveAs.getText().length() < 1) {
									Toast.makeText(ActivityForm2.this,
			...
			public void onClick(DialogInterface dialog, int i) {
				...
				case DialogInterface.BUTTON1: // yes, repeat
					...
					try {
						...
						ActivityForm2.this.createErrorDialog(e.getMessage(),
								EXIT);
						return;
					}
					if (!formController.indexIsInFieldList()) {
	...
	private void uploadFile() {
		...
		if (mInstanceUploaderTask == null) {
			...
			mInstanceUploaderTask.setUploaderListener(ActivityForm2.this);
